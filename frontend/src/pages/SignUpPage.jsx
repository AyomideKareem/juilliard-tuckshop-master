...
import { UserPlus, Mail, Lock, User, ArrowRight, Loader, IdCard } from "lucide-react";
...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-red-400'>Make Student account</h2>
			</motion.div>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									placeholder='Kareem Ayomide'
								/>
							</div>
						</div>
						<div>
							<label htmlFor='nfcCard' className='block text-sm font-medium text-gray-300'>
								Card
							</label>
							<div className='mt-1 relative rounded-md shadow-sm'>
								<div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									placeholder='juilliardstudent@juilliardacademy.org'
								/>
							</div>
						</div>
